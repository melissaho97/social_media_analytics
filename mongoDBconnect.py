...
class mongoDBconnect:
    ...
    def mongoDBconnect_to_collection(self):
    ...
    def insert_one_item(self, itemDictOne):
        ...
        x = self.mongoDBconnect_to_collection().insert_one(itemDictOne)
    ...
    def insert_many_item(self, itemDicts):
        ...
        x = self.mongoDBconnect_to_collection().insert_one(itemDicts)
...
if __name__ == '__main__':
    a = mongoDBconnect('mongodb://localhost:27017/', "WEBSCIENCE", "twitter_REST_search_geo")

    list, time = mongoDBconnect.count_quotes(a.mongoDBconnect_to_collection())
