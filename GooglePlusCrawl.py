...
service = apiclient.discovery.build('plus', 'v1', http=httplib2.Http(), developerKey="AIzaSyCeoTt0szZDhNRiImSP93uuqt94dKe1ikA")
...
analytic = []
count = 0
b = DBconnection('mongodb://localhost:27017/', "WEBSCIENCE", "GooglePlus_text_glasgow")
temp=start
while request != None:
    end = time.time()
